...
style="border-radius: 10px; margin-left: 50px; font-weight:
bold;">All
Crossings</button>
...
style="border-radius: 10px; margin-left: 800px; font-weight:
bold;">Logout</button>
