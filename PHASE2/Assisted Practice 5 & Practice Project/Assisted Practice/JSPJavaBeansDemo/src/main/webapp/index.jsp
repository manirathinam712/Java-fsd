...
<jsp:useBean id="productBean101" class="com.simpli.ProductBean" scope="session"></jsp:useBean>
...
<jsp:useBean id="productBean111" class="com.simpli.ProductBean" scope="session"></jsp:useBean>
